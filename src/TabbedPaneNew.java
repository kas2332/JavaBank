...
public class TabbedPaneNew {
    ...
    public static void main(String[] args) {
        TabbedPaneNew tabbedPaneNew = new TabbedPaneNew();
        tabbedPaneNew.tabbedPaneNew(tabbedPaneNew.username, tabbedPaneNew.fullName, tabbedPaneNew.accountNumber, tabbedPaneNew.balance, tabbedPaneNew.transaction1, tabbedPaneNew.transaction2, tabbedPaneNew.transaction3);
    }

    public void tabbedPaneNew(String username, String fullName, String accountNumberString, double balance, String transaction1, String transaction2, String transaction3) {
        ...
        DepositSlider.setMajorTickSpacing((int) (balance / 10));
        DepositSlider.setMinorTickSpacing((int) (balance / 20));
        ...
        WithdrawSlider.setMajorTickSpacing((int) (balance / 10));
        WithdrawSlider.setMinorTickSpacing((int) (balance / 20));
        ...
        TransferSlider.setMajorTickSpacing((int) (balance / 10));
        TransferSlider.setMinorTickSpacing((int) (balance / 20));
        ...
        VariableAccountNumber.setText(accountNumberString);
