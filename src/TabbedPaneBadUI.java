...
public class TabbedPaneBadUI {
    ...
    public static void main(String[] args) {
        TabbedPaneBadUI tabbedPaneBadUI = new TabbedPaneBadUI();
        tabbedPaneBadUI.tabbedPane(tabbedPaneBadUI.username);
    }
    ...
    public void tabbedPane(String usernameP) {
        ...
        JSlider DepositSliderCents = new JSlider(JSlider.VERTICAL);
        ...
        DepositSliderCents.setFont((font));
        DepositSliderCents.setMaximum(100);
        DepositSliderCents.setMajorTickSpacing(10);
        DepositSliderCents.setMinorTickSpacing(5);
        DepositSliderCents.setPaintLabels(true);
        DepositSliderCents.setPaintTicks(true);
        DepositSliderCents.setValue(0);
        DepositSliderCents.setInverted(true);
        ...
        DepositSliderPanelLayout.setHorizontalGroup(
                DepositSliderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(DepositSliderPanelLayout.createSequentialGroup()
                                ...
                                .addComponent(DepositSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 21, Short.MAX_VALUE)
                                .addComponent(DepositSliderCents, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
